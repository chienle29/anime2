...
class DatabaseService
{
    ...
    {
        global $wpdb;
        $results = $wpdb->get_results($wpdb->prepare("SELECT id, anime_saved_id, download_url FROM " . $this->getDbTableEpisodeName() . " WHERE anime_saved_id != %d AND is_downloaded = %s LIMIT 2", NULL, 0));
