            ...
            <div class="col-md-3 mb-4 stretch-card transparent">
                <div class="card card-tale" style="background: #7DA0FA">
                    <div class="card-body">
                        ...
                        <p class="fs-30 mb-2"><?php echo e($countUrl); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4 stretch-card transparent">
                <div class="card card-dark-blue" style="background: #4747a1">
                    <div class="card-body">
                        ...
                        <p class="fs-30 mb-2"><?php echo e($countSeriesSaved); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4 stretch-card transparent">
                <div class="card card-dark-blue" style="background: #7978e9">
                    <div class="card-body">
                        ...
                        <p class="fs-30 mb-2"><?php echo e($countAnimeUrl); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4 stretch-card transparent">
                <div class="card card-dark-blue" style="background: #f3797e">
                    <div class="card-body">
                        ...
                        <p class="fs-30 mb-2"><?php echo e($countAnimeSaved); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
</style><?php /**PATH /var/www/html/truyentranh/wp-content/plugins/ct-movie-crawler/app/views/report/main.blade.php ENDPATH**/ ?>